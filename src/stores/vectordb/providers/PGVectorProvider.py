...
from ..VectorDBEnums import (DistnaceMethodEnum,PgVectorDistnaceMethodEnum
...
class PGVectorProvider(VectorDBInterface):
    def __init__(self, db_client : str, default_vector_size: int = 786,
        ...
        if distance_method == DistnaceMethodEnum.COSINE.value:
            distance_method =PgVectorDistnaceMethodEnum.COSINE.value
        elif distance_method == DistnaceMethodEnum.DOT.value:
            distance_method =PgVectorDistnaceMethodEnum.DOT.value
